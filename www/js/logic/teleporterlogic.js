...
TeleporterLogic.CheckTeleporters = function(){
    ...
    if(counts.t0.length == 2){
        counts.t0[0].$tile.find('.spinner').attr('class', 'spinner rotate');
        counts.t0[1].$tile.find('.spinner').attr('class', 'spinner rotate');
    }
    if(counts.t1.length == 2){
        counts.t1[0].$tile.find('.spinner').attr('class', 'spinner rotate');
        counts.t1[1].$tile.find('.spinner').attr('class', 'spinner rotate');
    }
    if(counts.t2.length == 2){
        counts.t2[0].$tile.find('.spinner').attr('class', 'spinner rotate');
        counts.t2[1].$tile.find('.spinner').attr('class', 'spinner rotate');
    }
    if(counts.t3.length == 2){
        counts.t3[0].$tile.find('.spinner').attr('class', 'spinner rotate');
        counts.t3[1].$tile.find('.spinner').attr('class', 'spinner rotate');
    }
}
